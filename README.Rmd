...
This is not necessarily faster (only if less than the maximum number of rows is selected). selected), but it is memory efficient to load only certain columns or rows.
